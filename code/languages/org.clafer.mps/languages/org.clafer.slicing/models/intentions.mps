...
<model ref="r:cdddd3b0-99f8-412d-8456-f09e369b4d9a(org.clafer.slicing.intentions)">
  ...
  <node concept="2S6QgY" id="5u8lQlNZ2d9">
      ...
      <node concept="3clFbS" id="5u8lQlNZ2db" role="2VODD2">
        <node concept="3clFbF" id="5u8lQlNZ2Gt" role="3cqZAp">
          <node concept="Xl_RD" id="5u8lQlNZ2Gs" role="3clFbG">
            <property role="Xl_RC" value="Add Slice Controller" />
          </node>
        </node>
      </node>
    </node>
    ...
    <node concept="2SaL7w" id="5u8lQlNZ2P$" role="2ZfVeh">
      <node concept="3clFbS" id="5u8lQlNZ2P_" role="2VODD2">
        <node concept="3clFbF" id="5u8lQlNZ2Qc" role="3cqZAp">
          <node concept="2OqwBi" id="5u8lQlNZ3hh" role="3clFbG">
            <node concept="2OqwBi" id="5u8lQlNZ2Xr" role="2Oq$k0">
              <node concept="2Sf5sV" id="5u8lQlNZ2Qb" role="2Oq$k0" />
              <node concept="3CFZ6_" id="5u8lQlNZ39B" role="2OqNvi">
                <node concept="3CFYIy" id="5u8lQlNZ3e8" role="3CFYIz">
                  <ref role="3CFYIx" to="on7c:5u8lQlNXQOh" resolve="SliceController" />
                </node>
              </node>
            </node>
            <node concept="3w_OXm" id="5u8lQlNZ3mS" role="2OqNvi" />
          </node>
        </node>
      </node>
    </node>
